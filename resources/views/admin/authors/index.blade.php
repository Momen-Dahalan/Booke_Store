...
@section('content')
    <a href="{{ route('authors.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> أضف مؤلفًا جديدًا</a>
    <hr>
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive"> <!-- ✅ لضمان توافق الجدول مع الشاشات الصغيرة -->
                <table id="authors-table" class="table table-striped table-bordered text-right" width="100%">
                    <thead>
                        <tr>
                            <th>الاسم</th>
                            <th>الوصف</th>
